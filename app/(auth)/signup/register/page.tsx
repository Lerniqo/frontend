      ...
      <div className="flex-[4] flex flex-col justify-center items-start text-white p-10 relative z-10">
        ...
        <div className="max-w-md">
          <h1 className="text-5xl font-extrabold mb-4 text-white">
            Create Your <span className="text-white">Account</span>
          </h1>
          <p className="text-lg text-white/90 mb-8 leading-relaxed">
            {role === "Student"
              ? "Join thousands of students learning from expert teachers. Access personalized courses, track your progress, and unlock your full potential."
              : "Share your expertise with eager learners worldwide. Create engaging courses, build your teaching portfolio, and inspire the next generation."}
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <p className="text-[#6d28d9] mb-10 text-lg text-center font-medium">
            {role === "Student" ? "Student" : "Teacher"} Account Setup
          </p>
