  ...
  static filterTeachers(
    ...
    return teachers.filter((teacher) => {
      ...
      if (
        ...
        if (
          experience < filters.yearsOfExperience.min ||
      ...
      if (filters.hourlyRate && teacher.hourlyRate) {
        if (
          teacher.hourlyRate < filters.hourlyRate.min ||
...
export default function TeachersPage(): React.ReactElement {
  ...
  const loadTeachers = useCallback(
    async (page: number = 1, limit: number = 120) => {
      try {
        setIsLoading(true);
        setError(null);
  ...
  const hasActiveFilters = useMemo(() => {
    return (
      ...
      filters.verified ||
      (filters.hourlyRate
        ? filters.hourlyRate.min > 0 || filters.hourlyRate.max < 1000
        : false)
    );
  }, [filters]);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 animate-fade-in animation-delay-500">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4 leading-relaxed">
            Discover qualified educators who can help you achieve your learning
            goals. Browse through our extensive network of verified teachers.
          </p>
        </div>
        ...
        {error ? (
          ...
          <>
            {/* Teachers Grid/List */}
            <div
              className={`mb-12 animate-fade-in animation-delay-2000 ${
                viewMode === "grid"
