...
export default function ProfileNavigationButton() {
  ...
  useEffect(() => {
    ...
    gsap.set([settingButtonRef.current, logoutButtonRef.current], {
      opacity: 0,
      scale: 0,
      y: -10,
    });
  ...
  const toggleExpansion = () => {
    ...
    if (!isExpanded) {
      ...
      gsap.timeline().to([settingButtonRef.current, logoutButtonRef.current], {
        opacity: 1,
        scale: 1,
        y: 0,
        duration: 0.3,
      ...
      gsap.to([settingButtonRef.current, logoutButtonRef.current], {
        opacity: 0,
        scale: 0,
        y: -10,
        duration: 0.2,
