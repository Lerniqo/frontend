...
import { getNotifications, getQuestions, getResources, getWebinars, getAvailability, getContests, Notification, Question, Resource, Webinar, AvailabilitySlot, Contest } from '@/services/teacherDashboardService';
...
export default function TeacherDashboard() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const [notificationsRes, questionsRes, resourcesRes, webinarsRes, availabilityRes, contestsRes] = await Promise.all([
          getNotifications(),
          getQuestions(),
          getResources(),
          getWebinars(),
        ...
        return (
          <section className="py-16">
            <div className="text-center mb-20">
              ...
              <h2 className="text-6xl font-bold text-white mb-8 tracking-tight leading-tight">Manage Your Schedule</h2>
          ...
          <section className="py-16">
            <div className="text-center mb-20">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 backdrop-blur-xl rounded-full px-8 py-4 border border-white/20 mb-8">
                ...
                <span className="text-indigo-300 text-sm font-medium tracking-wide">Content Management</span>
              </div>
              <h2 className="text-6xl font-bold text-white mb-8 tracking-tight leading-tight">Manage Your Content</h2>
              <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">Create questions and share educational resources with your students</p>
            </div>
          ...
          <section className="py-16">
            <div className="text-center mb-20">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-xl rounded-full px-8 py-4 border border-white/20 mb-8">
                ...
                <span className="text-purple-300 text-sm font-medium tracking-wide">Profile</span>
              </div>
              <h2 className="text-6xl font-bold text-white mb-8 tracking-tight leading-tight">Your Profile</h2>
              <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">View and manage your teacher profile information</p>
            </div>
            <div className="max-w-5xl mx-auto">
              <div className="backdrop-blur-xl bg-white/10 rounded-3xl border border-white/20 shadow-2xl p-12 hover:bg-white/15 transition-all duration-500">
                <div className="text-center">
                  ...
                  <h3 className="text-3xl font-bold text-white mb-3">Teacher Name</h3>
                  <p className="text-slate-400 mb-12 text-lg">teacher@example.com</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    <div className="space-y-6">
                      ...
                      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                        ...
                        <p className="text-white text-lg">teacher@example.com</p>
                      </div>
                      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
          ...
          <section className="py-16">
            <div className="text-center mb-20">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-pink-500/20 to-rose-500/20 backdrop-blur-xl rounded-full px-8 py-4 border border-white/20 mb-8">
                ...
                <span className="text-pink-300 text-sm font-medium tracking-wide">Edit Profile</span>
              </div>
              <h2 className="text-6xl font-bold text-white mb-8 tracking-tight leading-tight">Edit Your Profile</h2>
              <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">Update your information and preferences</p>
            </div>
            <div className="max-w-5xl mx-auto">
              <div className="backdrop-blur-xl bg-white/10 rounded-3xl border border-white/20 shadow-2xl p-12 hover:bg-white/15 transition-all duration-500">
          ...
          <section className="py-16">
            <div className="text-center mb-20">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 backdrop-blur-xl rounded-full px-8 py-4 border border-white/20 mb-8">
                ...
                <span className="text-yellow-300 text-sm font-medium tracking-wide">Contest Management</span>
              </div>
              <h2 className="text-6xl font-bold text-white mb-8 tracking-tight leading-tight">Manage Your Contests</h2>
              <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">Create and manage educational contests for your students</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-slate-400 leading-relaxed mb-6 max-w-md">
                  Empowering teachers and students with innovative learning solutions.
                  Create, manage, and deliver exceptional educational experiences.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><a href="#" className="text-slate-400 hover:text-white transition-colors duration-300">Dashboard</a></li>
                  <li><a href="#" className="text-slate-400 hover:text-white transition-colors duration-300">Schedule</a></li>
                  <li><a href="#" className="text-slate-400 hover:text-white transition-colors duration-300">Content</a></li>
                  <li><a href="#" className="text-slate-400 hover:text-white transition-colors duration-300">Profile</a></li>
                </ul>
              </div>
            ...
            <div className="border-t border-white/10 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-slate-400 text-sm mb-4 md:mb-0">
                  © 2025 Lerniqo. All rights reserved. Built with ❤️ for educators.
                </p>
                <div className="flex items-center space-x-6">
                  ...
                  <span className="text-slate-400 text-sm">for the future of education</span>
                </div>
              </div>
            </div>
          </div>
