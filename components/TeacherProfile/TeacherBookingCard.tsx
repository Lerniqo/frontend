        ...
        <div className="space-y-6 mb-8">
          <div className="flex items-start group">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Book lessons at your convenience with our intuitive calendar
                system. Choose from available time slots that fit your schedule
                perfectly.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start group">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                All our tutors undergo rigorous verification and background
                checks to ensure quality education and your safety.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start group">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Get immediate booking confirmation and calendar invites. Start
                learning without any delays or complications.
              </p>
            </div>
          </div>
        </div>
