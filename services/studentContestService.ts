...
const mockStudentContests: StudentContest[] = [
  {
    ...
    description: 'Test your mathematical prowess in this comprehensive contest covering algebra, geometry, and calculus.',
  ...
  },
  {
    ...
    description: 'Explore the fascinating world of physics, chemistry, and biology through challenging experiments and questions.',
  ...
  },
  {
    ...
    description: 'Dive deep into classic and contemporary literature, showcasing your analytical and creative writing skills.',
...
export const getStudentContests = async (): Promise<ApiResponse<StudentContest[]>> => {
...
export const joinContest = async (contestId: string): Promise<ApiResponse<StudentContest>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export const leaveContest = async (contestId: string): Promise<ApiResponse<StudentContest>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      const contest = mockStudentContests.find(c => c.id === contestId);
      if (contest) {
