...
export const markNotificationAsRead = async (id: string): Promise<ApiResponse<boolean>> => {
...
export const createContest = async (contest: Omit<Contest, 'id' | 'participants' | 'status'>): Promise<ApiResponse<Contest>> => {
...
export const addQuestion = async (question: Omit<Question, 'id'>): Promise<ApiResponse<Question>> => {
  await new Promise(resolve => setTimeout(resolve, 800));
...
export const uploadResource = async (resource: Omit<Resource, 'id' | 'uploadedAt' | 'downloads'>): Promise<ApiResponse<Resource>> => {
...
export const scheduleWebinar = async (webinar: Omit<Webinar, 'id' | 'attendees' | 'status'>): Promise<ApiResponse<Webinar>> => {
  await new Promise(resolve => setTimeout(resolve, 800));
...
export const updateAvailability = async (slots: AvailabilitySlot[]): Promise<ApiResponse<boolean>> => {
  await new Promise(resolve => setTimeout(resolve, 800));
